...
- TypeScript 5.6, Vite 6.4.1 + Phaser 3.80 (renderer), Capacitor 6.2 (native bridge), @capacitor-community/admob 6.2.0 (ads) (main)
- localStorage + IndexedDB fallback (HighScoreRecord persistence) (main)
...
## Recent Changes
- main: Added TypeScript 5.6, Vite 6.4.1 + Phaser 3.80 (renderer), Capacitor 6.2 (native bridge), @capacitor-community/admob 6.2.0 (ads)
