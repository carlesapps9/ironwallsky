...
- [x] T012 [US4] Run `npm run build` and open `dist/index.html` in a browser (or `npm run preview`) to verify zero CSP violation errors in DevTools console for Phaser canvas renderer, service worker script, and web manifest link
